...
function downloaddata(){
	...
	xmlhttp.onreadystatechange=function()
	{
		...
		{
			downlarray = xmlhttp.responseText;
		}
	}
	xmlhttp.open("GET","checktest.php",true);
	xmlhttp.send();
		var obj = eval ("(" + downlarray + ")");

		document.getElementById("Price").innerHTML=obj[0].price;
		document.getElementById("Model").innerHTML=obj[1].model;

			//need work still
			//add to options with var price or model
...
<body  onload = downloaddata() id="xxx">
...
<option value="http://www.DIVCSS5.com/"><span id="fname"></span></option>
