...
<img src="./resources/img/cnet_logo.png" height="100" width="100" style="position: absolute; bottom: 10px; right: 380px; z-index: 8;"><br>
...
<div id="content2">
	...
	<div id="container-rf" style="margin: 0px 0px 10px 10px; left: 1170px; top: 420px; bottom: auto; text-align:right">
		...
		<div>
			<h1 style="font-size: 18px;">CNET Rating: 4.4/5.0</h1>
		</div>
	</div>
